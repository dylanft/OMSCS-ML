...
for n in n_depth:
    ...
    for iteration in range(0, numIterations):
        ...
        hiddens = tuple(n * [100])
        clf = MLPClassifier(solver='lbfgs', hidden_layer_sizes=hiddens, random_state=1) #can also test learning rate (alpha)
...
fig.savefig('figures/ph/nn/poker-hand_nn_hidden.png')
plt.close(fig)

thefile = open('data/ph/nn/poker-hand_nn_hidden.txt', 'w')

thefile.write("Number of Layerss:\n")
for item in n_depth:
...
# fig.savefig('figures/ph/nn/poker-hand_nn_tsize.png')
# plt.close(fig)
#
# thefile = open('data/ph/nn/poker-hand_nn_tsize.txt', 'w')
#
