...
plt.ylabel('Accuracy')
plt.legend(loc='best')
plt.title('K Values versus Accuracy (hand)')
fig.savefig('figures/ph/knn/poker-hand_knn_kvalues.png')
plt.close(fig)

thefile = open('data/ph/knn/poker-hand_knn_kvalues.txt', 'w')
...
# fig.savefig('figures/ph/knn/poker-hand_knn_trainingsize.png')
# plt.close(fig)
#
# thefile = open('data/ph/knn/poker-hand_knn_trainingsize.txt', 'w')
#
