...
train, test = train_test_split(dff, test_size = 0.20, random_state=1)
...
# fig.savefig('figures/cc/svm/credit-card_svm_gamma_rbf.png')
# plt.close(fig)
#
# thefile = open('data/cc/svm/credit-card_svm_gamma_rbf.txt', 'w')
#
# thefile.write("Gamma:\n")
# for item in gamma:
...
for n in training_size:
    ...
    for iteration in range(0, numIterations):
        clf = svm.SVC(kernel='poly', gamma=0.1, random_state=1)
...
fig.savefig('figures/cc/svm/credit-card_svm_tsize.png')
plt.close(fig)

thefile = open('data/cc/svm/credit-card_svm_tsize.txt', 'w')
